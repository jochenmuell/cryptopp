...
#define BLAKE2S_G1(row1, row2, row3, row4, buf)       \
    do                                                \
    {                                                 \
        row1 = vaddq_u32(vaddq_u32(row1, buf), row2); \
        row4 = veorq_u32(row4, row1);                 \
        row4 = vrorq_n_u32_16(row4);                  \
        row3 = vaddq_u32(row3, row4);                 \
        row2 = veorq_u32(row2, row3);                 \
        row2 = vrorq_n_u32(row2, 12);                 \
    } while (0)
...
#define BLAKE2S_G2(row1, row2, row3, row4, buf)       \
    ...
    {                                                 \
        row1 = vaddq_u32(vaddq_u32(row1, buf), row2); \
        row4 = veorq_u32(row4, row1);                 \
        row4 = vrorq_n_u32_8(row4);                   \
        row3 = vaddq_u32(row3, row4);                 \
        row2 = veorq_u32(row2, row3);                 \
        row2 = vrorq_n_u32(row2, 7);                  \
    } while (0)
